...
public class Node2 {
    ...
    {
        try {
            serverSocket = new DatagramSocket(Node2Port);
    ...
    public void Init() throws Exception {
        ...
        //到其他节点到最小代价
        DataPack.minCost[0] = 2;
        DataPack.minCost[1] = 8;
        DataPack.minCost[2] = 0;
        ...
        System.out.println("Node2节点启动，路由表如下：");
        System.out.println("******************************************");
                    ...
                    while (true) {
                        ...
                        if (tempSource == 1) {
                            if (DataPack.minCost[1] + cost[0] < DataPack.minCost[0]) {//通过1到达0
                                ...
                                DataPack.export[0] = 1;
                                System.out.println("更新Node2到Node0的代价和出口");
                                isChanged = true;
                            }

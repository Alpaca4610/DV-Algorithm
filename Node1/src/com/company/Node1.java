...
public class Node1 {
    ...
    {
        try {
            serverSocket = new DatagramSocket(Node1Port);
    ...
    public void Init() throws Exception {
        ...
        //到其他节点到最小代价
        DataPack.minCost[0] = 3;
        DataPack.minCost[1] = 0;
        DataPack.minCost[2] = 8;
        DataPack.minCost[3] = 7;
        ...
        System.out.println("Node1节点启动，路由表如下：");
        System.out.println("******************************************");
                    ...
                    while (true) {
                        ...
                        if (tempSource == 0) {
                            if (DataPack.minCost[0] + cost[2] < DataPack.minCost[2]) {//通过0到达2
                                ...
                                DataPack.export[2] = 0;
                                System.out.println("更新Node1到Node2的代价和出口");
                                isChanged = true;
                            }
                            if (DataPack.minCost[0] + cost[3] < DataPack.minCost[3]) {//通过0到达3
                                DataPack.minCost[3] = DataPack.minCost[0] + cost[3];
                                DataPack.export[3] = 0;
                                System.out.println("更新Node1到Node3的代价和出口");
                                isChanged = true;
                            }
                        }
                        if (tempSource == 2) {
                            if (DataPack.minCost[2] + cost[0] < DataPack.minCost[0]) {//通过2到达0
                                ...
                                DataPack.export[0] = 2;
                                System.out.println("更新Node1到Node1的代价和出口");
                                isChanged = true;
                            }
                        ...
                        if (tempSource == 3) {
                            if (DataPack.minCost[3] + cost[0] < DataPack.minCost[0]) {//通过3到达0
                                DataPack.minCost[0] = DataPack.minCost[3] + cost[0];
                                DataPack.export[0] = 3;
                                System.out.println("更新Node1到Node0的代价和出口");
                                isChanged = true;
                            }
